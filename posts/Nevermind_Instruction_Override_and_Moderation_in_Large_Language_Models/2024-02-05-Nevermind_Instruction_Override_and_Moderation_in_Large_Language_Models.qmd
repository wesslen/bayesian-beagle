...
id: "2402.03303v1"
description: "LLMs perform best in following instructions, but larger models can be too obedient."
author: Edward Kim
date: "2024-02-05"
...
### **Summary:**
- Investigates and benchmarks Large Language Models (LLMs) on the task of explicit instruction following in conflicting situations, e.g. overrides.
...
- Over-alignment of the models destroys model weights and reduces their general capabilities; thus, an alternative framework has been developed and demonstrated that has parallels to neuro-inspired cognitive control.
